...
private:
    ...
    bool validChecker(int start, int end, const string& lineOfCode);
    void processNumber(size_t& i, const std::string& lineOfCode, std::ostream& outfile, bool& error);
    void processString(size_t& i, const std::string& lineOfCode, std::ostream& outfile, bool& error);
    void processKeywordOrIdentifier(size_t& i, const std::string& lineOfCode, std::ostream& outfile, bool& error);
    void processIdentifier(size_t& i, const std::string& lineOfCode, std::ostream& outfile, bool& error, bool& found);
